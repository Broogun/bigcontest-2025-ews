...
│                         │                 │                          │
│  · 입력: dw_f_* 18개     │                 │  · 위험 등급 분류           │
│  · 11개 모델 성능 비교     │                 │    (risk_rank_opt 기반)    │
│    LightGBM AUC 0.797   │                 │  · 3-컴포넌트 시각화         │
│    → EWS 유효성 확인      │                 │    (s_int / s_comp / s_ext)│
│  · SHAP: 피처 기여도      │                 │  · 피처별 백분위 상세        │
│    설명 및 시각화          │                 │    (rank_f_* 18개)         │
│  · 앙상블 성능 실험        │                 │  · AI 리포트 (Claude Haiku)│
│    (Voting/Stacking/    │                 │  · 맞춤 금융상품 매칭         │
│     Hybrid 모두 테스트)   │                 │                          │
└─────────────────────────┘                 └──────────────────────────┘
       성능 벤치마크 & 설명 도구                    최종 운영 시스템
```
